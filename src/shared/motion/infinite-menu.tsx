        ...
        `}
          ...
          ${
            isMoving
              ...
              : 'opacity-100 pointer-events-auto duration-[500ms] translate-x-[-40%] md:translate-x-[-67%] lg:translate-x-[-63%] xl:translate-x-[-60%] -translate-y-1/2'
          }
        `}
          >
          ...
          ${
            isMoving
              ? 'bottom-[-64px] md:bottom-[-72px] lg:bottom-[-80px] xl:bottom-[-88px] opacity-0 pointer-events-none duration-[100ms] scale-0 -translate-x-1/2'
              : 'bottom-[2.8em] md:bottom-[3.2em] lg:bottom-[3.8em] xl:bottom-[4.2em] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2'
          }
        `}
          >
