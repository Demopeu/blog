...
- ✅ Next.js: 15.0.5, 15.1.9, 15.2.6, 15.3.6, 15.4.8, 15.5.7, 16.0.10
...
**React 19.2.3 및 React-DOM 19.2.3, Next.js 16.0.10으로 즉시 업데이트하여 모든 취약점 패치 적용**
...
| next      | 16.0.10   | 16.0.10   | -           | ✅ 안전 | 16.0.7 → 16.0.10 |
