import ZipImage from '@/app/assets/portfolio/zip.png';
import VybzImage from '@/app/assets/portfolio/vybz.png';
import StarbucksImage from '@/app/assets/portfolio/starbucks.png';
import MannaImage from '@/app/assets/portfolio/manna.webp';
...
export const infiniteItems: InfiniteItem[] = [
  {
    image: '/portfolio/manna.webp',
    link: 'https://github.com/Demopeu/manna-church-service',
    title: '만나교회\n서비스\n플랫폼',
    description:
      '- Next.js 16\n- 모노레포 빌드 최적화\n- Clean FSD 아키텍처\n- PWA (Serwist) 도입',
  },
...
export const carouselItems: CarouselItem[] = [
  {
    link: 'https://github.com/Demopeu/manna-church-service',
    title: '만나교회 프로젝트',
    subtitle: 'PPR 홈페이지와 관리자 CMS',
    description:
      '디지털 소외 계층인 고령 성도를 위한 사용자 웹과 비전문가 목사님을 위한 관리자 CMS로 구성된 서비스',
    contribution: [
      'Turborepo 캐시 히트율 향상 및 내부 패키지 사전 빌드 최적화',
      'CQRS 접목 Clean FSD 아키텍처 설계',
      'Server Actions + Zod 기반 CMS 인증 및 유효성 검증 파이프라인 구축',
      'Client Boundary 분리로 Hydration Mismatch 해결 및 RSC 캐싱 제어',
      'pdfjs-dist Dynamic Import 전환으로 SSR 번들 최적화',
  ...
  },
  {
    ...
    description:
      '버스킹 공연 홍보 공간의 부재 / 홍보 어려움을 해결하기 위한 생태계 제작 프로젝트',
    contribution: [
  ...
  },
  {
    ...
    title: '스타벅스 리뉴얼 프로젝트',
    description:
      '초기 로딩 속도와 SEO를 개선한 스타벅스 온라인 쇼핑몰 리뉴얼 프로젝트',
    contribution: [
      'SSR/CSR 혼합 구조 설계로 초기 로딩 최적화 및 SEO 대응',
      'shadcn UI + Zustand 조합으로 디자인 일관성과 상태 분리 구조 구현',
      'Optimistic UI, 태그 기반 캐싱, 전역 상태 관리 등 실제 서비스와 동일한 사용자 경험 설계',
      'Next.js 15 캐시 전략 및 React 리렌더링 최적화 ',
    ],
  ...
  },
  {
    ...
    description:
      '무한 댓글 쓰레드를 제공하고 각 요약 정보를 AI가 실시간 생성하여 보여주는 기능을 구현한 프로젝트',
    contribution: [
      'flat 댓글 데이터를 parent-child 트리 구조로 변환하여 UI 성능 최적화',
      '페이지 리셋 없이 댓글 추가, localStorage 활용으로 UX 개선',
      'Skeleton UI, refetch, append 등 전략 테스트를 통해 사용성과 유지보수성 간 균형 달성',
    ],
