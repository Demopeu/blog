...
export function composeProviders(
  ...
  const Base: React.ComponentType<{ children: React.ReactNode }> = ({ children }: { children: React.ReactNode }) => (
    <>{children}</>
  );

  const Composed = providers.reduce<React.ComponentType<{ children: React.ReactNode }>>(
    (Accum, Provider) => {
