  ...
  if (attribLocations) {
    for (const attrib in attribLocations) {
      if (Object.prototype.hasOwnProperty.call(attribLocations, attrib)) {
        gl.bindAttribLocation(program, attribLocations[attrib] ?? 0, attrib);
      }
    }
  }
  ...
  return (
    <div className="relative w-full h-full">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-grab w-full h-full overflow-hidden relative outline-none active:cursor-grabbing bg-background"
      />
      ...
      {activeItem && (
        ...
        `}
          ...
          ${
            isMoving
              ? 'opacity-0 pointer-events-none duration-100 translate-x-[-50%] md:translate-x-[-52%] lg:translate-x-[-55%] xl:translate-x-[-58%] -translate-y-1/2'
              : 'opacity-100 pointer-events-auto duration-500 translate-x-[-40%] md:translate-x-[-67%] lg:translate-x-[-63%] xl:translate-x-[-60%] -translate-y-1/2'
          }
        `}
          >
          ...
          left-1/2
          z-10
          w-10 h-10 md:w-[56px] md:h-[56px] lg:w-[60px] lg:h-[60px] xl:w-[68px] xl:h-[68px]
          grid
          place-items-center
          bg-foreground
          border-[3px] md:border-4 lg:border-[5px]
          border-background
          rounded-full
          cursor-pointer
          transition-all
          ...
          ${
            isMoving
              ? 'bottom-[-64px] md:bottom-[-72px] lg:bottom-[-80px] xl:bottom-[-88px] opacity-0 pointer-events-none duration-100 scale-0 -translate-x-1/2'
              : 'bottom-[2.8em] md:bottom-[3.2em] lg:bottom-[3.8em] xl:bottom-[4.2em] opacity-100 pointer-events-auto duration-500 scale-100 -translate-x-1/2'
          }
        `}
          >
            <Github className="select-none relative text-background top-[2px] w-7 h-7 md:w-[22px] md:h-[22px] lg:w-[26px] lg:h-[26px] xl:w-[28px] xl:h-[28px]" />
          </div>
        </>
      )}
    </div>
